  ...
  return (
    <section className="py-20 md:py-32 border-b border-[var(--border-primary,#333)] relative overflow-hidden transition-colors duration-300">
      <div className="max-w-[1240px] mx-auto px-6 md:px-12 flex flex-col items-start text-left relative z-10">
        ...
        <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-7xl lg:text-8xl leading-[1] md:leading-[0.9] uppercase text-[var(--text-primary,#E0E0E0)] max-w-4xl mb-8 break-words sm:break-normal">
          BUILD WORK THAT MOVES BUSINESSES FORWARD.
        </h1>
