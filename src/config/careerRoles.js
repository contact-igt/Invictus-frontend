...
const socialMediaManager = {
  ...
  salary: "",
  employmentType: "Full-time",
  minExperience: "Chennai (Hybrid) • Full-time • 6 months–1 year preferred",
  freshersAllowed: "",
  applicationMaterialLabel: "Resume or LinkedIn",
  estimatedMinutes: "2–3 minutes",
  summary:
    "Manage social media activities, create engaging content, and support smooth marketing execution. Primarily focused on social media management, content planning, content writing, trend research, and brand communication, with coordination support to keep projects, client requirements, and internal workflows moving smoothly.",
  positioning: [
    "Role: Social Media & Marketing Operations Associate.",
    "Location: Chennai. Work Mode: Hybrid.",
    "Primary focus is social media, content, and marketing execution.",
    "This role is NOT a full-time HR role, employee management role, recruitment role, or complete operations management role.",
    "We're looking for someone who loves creating content, understands social media trends, and takes ownership of assigned tasks.",
    "Someone who wants to grow in digital marketing and business execution.",
  ],
  responsibilities: [
    "Manage social media pages and content activities.",
    "Plan content calendars and monthly content ideas.",
    "Write captions, social media copies, and marketing content.",
    "Research current social media trends and content formats.",
    "Understand hashtags, engagement, and content optimisation.",
    "Suggest creative ideas for campaigns, reels, and posts.",
    "Coordinate with designers and video editors for content execution.",
    "Communicate with clients regarding content requirements, approvals, and updates when required.",
    "Understand client feedback and coordinate with internal creative teams.",
    "Track content progress and follow up on pending tasks.",
    "Ensure marketing activities move according to timelines.",
    "Support smooth workflow between content, design, video, and marketing teams.",
    "Maintain basic trackers and campaign updates.",
    "Assist in organising tasks and project requirements, and help improve execution processes.",
  ],
  requirements: [
    "Good communication skills.",
    "Strong content writing ability.",
    "Understanding of social media platforms.",
    "Creative thinking and idea generation.",
    "Awareness of current trends.",
    "Good organisation and follow-up skills.",
    "Minimum 6 months – 1 year experience preferred, with practical exposure to social media management, content writing, content planning, and digital marketing activities.",
  ],
  preferred: [
    "Social media management experience.",
    "Content planning experience.",
    "Basic SEO knowledge.",
    "Understanding of hashtags and social media optimisation.",
    "Experience working with brands or agencies.",
    "Healthcare content knowledge preferred.",
  ],
  missingMaterialFlag: "RESUME_MISSING",
  screens: [
    contactScreen(),
    locationScreen(),
    experienceScreen("How many years of social media, content, or digital marketing experience do you have?"),
    {
      id: "resume",
