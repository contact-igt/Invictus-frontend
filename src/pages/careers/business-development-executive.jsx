...
const role = careerRoles["business-development-executive"];
    ...
    <>
      ...
      <div className="w-full relative min-h-screen pt-20 md:pt-24 bg-[var(--bg-primary,#0E0E0E)] text-[var(--text-primary,#E0E0E0)] font-body">
        <div className="max-w-[1000px] mx-auto px-6 md:px-12 py-12 md:py-24">
          ...
          {/* Hero */}
          <div className="mb-16">
            <span className="text-[#2AB182] font-display font-bold text-sm tracking-widest uppercase mb-6 block">
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 text-xs font-bold text-[var(--text-secondary,#A0A0A0)] uppercase mb-8 font-body">
              ...
              {role.freshersAllowed && (
                <span className="border border-[#2AB182]/40 text-[#2AB182] px-4 py-2 font-body bg-[#2AB182]/5">
                  {role.freshersAllowed}
                </span>
              )}
            </div>
          ...
          <div className="text-[var(--text-secondary,#A0A0A0)] font-body">
            <h2 className="text-2xl font-display font-bold text-[var(--text-primary,#E0E0E0)] mb-6">What You’ll Be Doing</h2>
            ...
            <h2 className="text-2xl font-display font-bold text-[var(--text-primary,#E0E0E0)] mb-6">What We’re Looking For</h2>
            <ul className="list-disc pl-5 space-y-3 mb-12 font-body">
            ...
            <h2 className="text-2xl font-display font-bold text-[var(--text-primary,#E0E0E0)] mb-6">Preferred Skills & Experience</h2>
            <ul className="list-disc pl-5 space-y-3 mb-12 font-body">
