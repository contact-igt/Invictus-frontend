...
const role = careerRoles["hr-operations-executive"];

export default function HrOperationsExecutivePage() {
  const jsonLd = {
        ...
        <div className="max-w-[1000px] mx-auto px-6 md:px-12 py-12 md:py-24">
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 text-xs font-bold text-[var(--text-secondary,#A0A0A0)] uppercase mb-8 font-body">
              <span className="border border-[#2AB182]/40 text-[#2AB182] px-4 py-2 font-body bg-[#2AB182]/5">{role.salary}</span>
              <span className="border border-[var(--border-subtle,#333)] px-4 py-2 font-body">Probation: {role.probationPeriod}</span>
              <span className="border border-[var(--border-subtle,#333)] px-4 py-2 font-body">Commitment: {role.minimumCommitment}</span>
            </div>
