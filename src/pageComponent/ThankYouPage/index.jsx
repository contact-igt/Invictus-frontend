...
const ThankYouPage = () => {
    ...
    return (
        <div className="pt-32 min-h-screen flex flex-col justify-center items-center px-6 md:px-12 bg-[#0E0E0E] relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="max-w-3xl w-full mx-auto text-center relative z-10">
                ...
                {/* Heading */}
                <h1 className="font-display font-bold text-5xl md:text-7xl text-white uppercase mb-6 leading-tight">
                    Message <br />
                ...
                {/* Confirmation Text */}
                <p className="font-body text-lg md:text-xl text-[#888] mb-12 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                    <button
                        onClick={() => router.push('/')}
                        className="group flex items-center gap-3 bg-[#2AB182] text-black px-8 py-4 font-display font-bold uppercase tracking-widest hover:bg-white transition-all duration-300"
                    >
                        <Home size={20} />
                        Back to Home
                    </button>
                    ...
                    <button
                        ...
                        className="group flex items-center gap-3 border border-[#333] text-white px-8 py-4 font-display font-bold uppercase tracking-widest hover:border-[#2AB182] hover:text-[#2AB182] transition-all duration-300"
                    >
                        Explore Services
