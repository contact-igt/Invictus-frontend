        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((val, idx) => (
              <div
                key={idx}
                className="p-8 border border-[#333] rounded-lg bg-[#0E0E0E] hover:border-[#2AB182] active:border-[#2AB182] transition-colors duration-300 group"
              >
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pillars.map((pillar, idx) => (
              <div
                key={idx}
                className="p-8 border border-[#333] rounded-lg bg-[#0E0E0E] hover:border-[#2AB182] active:border-[#2AB182] transition-colors duration-500 group"
              >
