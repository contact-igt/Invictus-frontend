...
const AreasWeSupport = () => {
    return (
        <section className="py-20 bg-navy-midnight text-[var(--text-primary)] font-open-sans">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="lg:w-1/2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex items-center gap-3 bg-white/5 p-3 rounded-md hover:bg-[var(--text-primary)]/10 transition cursor-default">
