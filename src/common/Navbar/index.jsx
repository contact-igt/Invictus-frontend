...
const Navbar = ({ isMenuOpen, toggleMenu, handleNavClick, currentView }) => {
  return (
    <>
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-4 flex justify-between items-center">
          ...
          >
            ...
            <span className="font-display font-bold text-xl tracking-tighter uppercase text-white group-hover:text-[#2AB182] transition-colors ">
              Invictus
              <span className="text-[10px] align-top ml-0.5 text-[#2AB182]">
                ©
              </span>
            </span>
          </a>
          ...
          <div className="hidden md:flex gap-12 text-xs font-bold tracking-[0.2em] uppercase font-body">
            <a
              ...
              className="relative hover:text-[#2AB182] transition-colors"
            >
              Services
            </a>
            <a
              href="#industries"
              onClick={(e) => handleNavClick(e, "home", "industries")}
              className="relative hover:text-[#2AB182] transition-colors"
            >
              Industries
            </a>
            ...
            <a
              ...
              className={`relative hover:text-[#2AB182] transition-colors ${
                currentView === "about" ? "text-[#2AB182]" : ""
              }`}
            >
              About
            </a>
            <a
              href="https://metaads.invictusglobaltech.com/"
              className="hover:text-[#2AB182]"
              target="_blank"
            >
              Meta Adds
            </a>
          ...
          <button
            onClick={toggleMenu}
            className="md:hidden text-white hover:text-[#2AB182] transition-colors"
          >
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 bg-[#0E0E0E] z-40 flex items-center justify-center transition-transform duration-500 ease-in-out ${
